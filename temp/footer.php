         ...
         <div class="row"style="background-color:green;">
             ...
             <div class="col-4">                    
               ...
               <!-- <p class = "p1">-->
                ...
                <a class="envelope" href="#"><i class="fa fa-envelope"></i>brinck@mail.ru</a><br>
              
                Юр. адрес: 350047. г.Ростов-на-Дону.<br> ул. Бабушкина, 38/3
            </div>
            ...
            <div class="text">
             <h6>Дорогой друг</h6>
             <p style="font-size:12px">Наша команда будет  рада помочь Вам с выбором товаров. У нас большой выбор.
     </div>
